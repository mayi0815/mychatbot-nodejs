...
// config
app.set('port', process.env.PORT || 8199);
...
const server = app.listen(app.get('port'), () => {
    console.log('Server listening on port http://localhost:8199',app.get('port'));
});
...
io.on('connection', function(socket) {
    socket.on('chat message', (text) => {
        ...
        //@TODO : REMPLACE WITH RETURNING MESSAGE OF CHATGPT
